...
def gsi(rn,db,sheetname,file_name,p,l):
        global sname,regino,an,ab
        an=[]
        ab=[]
        print_sheetname=sheetname
        fn=str(file_name)+".xlsx"
        fname=p+"\\"+str(file_name)+".xlsx"
        ro=1
        count=0
        ...
        for x,y in zip(rn,db):
                ...
                url = l
                if "/ugresult.asp" in l:
                        link1=url.replace("/ugresult.asp","/ugresultpage.asp")
                elif "ugresult.asp" in l:
                        link1=url.replace("ugresult.asp","/ugresultpage.asp")
                elif "/ugresult.asp/" in l:
                        link1=url.replace("/ugresult.asp/","/ugresultpage.asp")
                elif "/ugresultpage.asp" in l:
                        link1=l
                elif "/results/" in l:
                        link1=l+"ugresultpage.asp"
                elif "/results" in l:
                        link1=l+"/ugresultpage.asp"
                url = link1
